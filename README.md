...
function redzlib:MakeWindow(Configs)
	...
	local function ControlSize()
		...
		ControlSize1.Position = UDim2.fromOffset(math.clamp(Pos1.X.Offset, 380, 900), math.clamp(Pos1.Y.Offset, 180, 450))
		ControlSize2.Position = UDim2.new(0, math.clamp(Pos2.X.Offset, 120, 220), 1, 0)
	...
	function Window:MinimizeBtn()
		...
		if Minimized then
			...
			CreateTween({MainFrame, "Size", UDim2.fromOffset(MainFrame.Size.X.Offset, 25), 0.25, true})
			Minimized = true
		end
	...
	function Window:AddMinimizeButton(Configs)
		...
		if Configs.Corner then
			Corner = Make("Corner", Button, UDim.new(0, 8))
	...
	function Window:Dialog(Configs)
		...
		local Frame = Create("Frame", {
			Active = true,
			Size = UDim2.fromOffset(220 * 1.08, 130 * 1.08),
		...
		Make("Corner", Screen, UDim.new(0, 14))
		Frame.Parent = Screen
		CreateTween({Frame, "Size", UDim2.fromOffset(220, 130), 0.2})
		...
		function Dialog:Button(Configs)
			...
			for _,Button in pairs(ButtonsHolder:GetChildren()) do
				if Button:IsA("TextButton") then
					Button.Size = UDim2.new(1 / ButtonCount, -(((ButtonCount - 1) * 16) / ButtonCount), 0, 28)
				end
			end
		...
		function Dialog:Close()
			CreateTween({Frame, "Size", UDim2.fromOffset(220 * 1.08, 130 * 1.08), 0.2})
	...
	function Window:MakeTab(paste, Configs)
		...
		local LabelTitle = InsertTheme(Create("TextLabel", TabSelect, {
			Size = UDim2.new(1, TIcon and -22 or -12, 1),
			Position = UDim2.fromOffset(TIcon and 22 or 12),
			BackgroundTransparency = 1,
			Font = Enum.Font.GothamMedium,
			Text = TName,
			TextColor3 = Theme["Color Text"],
		...
		local Selected = InsertTheme(Create("Frame", TabSelect, {
			Size = FirstTab and UDim2.new(0, 3, 0, 3) or UDim2.new(0, 3, 0, 12),
		...
		local function Tabs()
			...
			CreateTween({Selected, "Size", UDim2.new(0, 3, 0, 12), 0.35})
		...
		function Tab:AddParagraph(Configs)
			...
			local Frame, LabelFunc = ButtonFrame(Container, PName, PDesc, UDim2.new(1, -18))
		...
		function Tab:AddButton(Configs)
			...
			local FButton, LabelFunc = ButtonFrame(Container, BName, BDescription, UDim2.new(1, -18))
		...
		function Tab:AddToggle(Configs)
			...
			local Button, LabelFunc = ButtonFrame(Container, TName, TDesc, UDim2.new(1, -35))
		...
		function Tab:AddDropdown(Configs)
			...
			local Button, LabelFunc = ButtonFrame(Container, DName, DDesc, UDim2.new(1, -170))
			...
			local function Disable()
				...
				CreateTween({DropFrame, "Size", UDim2.new(0, 142, 0, 0), 0.2, true})
			...
			local function GetFrameSize()
				return UDim2.fromOffset(142, ScrollSize)
			end
			...
			local function CalculateSize()
				...
				ScrollSize = (math.clamp(Count, 0, 8) * 22) + 8
				...
				local function UpdateSelected()
					if MultiSelect then
						for _,v in pairs(Options) do
							...
							CreateTween({nodes[2], "Size", Stats and UDim2.fromOffset(3, 10) or UDim2.fromOffset(3, 3), 0.35})
						...
						for _,v in pairs(Options) do
							...
							CreateTween({nodes[2], "Size", Slt and UDim2.fromOffset(3, 12) or UDim2.fromOffset(3, 3), 0.35})
